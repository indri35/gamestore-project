    ...
    <nav class="navbar-admin">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}"><p><img src="{{ asset('img_game/logo.png') }}" width="30" height="30" alt="Logo">Game Asik Game Store (Administrator) </p></a>
            </div>
